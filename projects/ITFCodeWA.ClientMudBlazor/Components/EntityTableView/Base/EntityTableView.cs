...
namespace ITFCodeWA.ClientMudBlazor.Components.EntityTableView.Base
{
    public abstract partial class EntityTableView<TModel, TKey, TApiService> : ComponentBase
