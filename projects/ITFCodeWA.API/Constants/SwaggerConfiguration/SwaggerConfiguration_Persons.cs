namespace ITFCodeWA.API.Constants
{
    public static partial class SwaggerConfiguration
    {
        ...
        {
            public const string TAG_DESCRIPTION = "Справочник <b>Физические лица</b>";

            public const string GET_RESPONSE_DESCRIPTION = "Получение информация о физическом лице";
            ...
            public const string POST_RESPONSE_DESCRIPTION = "Внесение информации о физическом лице";
            public const string POST_OPERATION_SUMMARY = "POST-OPERATION SUMMARY";
            public const string POST_OPERATION_DESCRIPTION = "POST-OPERATION DESCRITION";

            public const string PUT_RESPONSE_DESCRIPTION = "Обноление информация о физическом лице";
            ...
            public const string DELETE_RESPONSE_DESCRIPTION = "Уделение информация о физическом лице";
            ...
            public const string GET_PAGE_RESPONSE_DESCRIPTION = "Информация о физическом лице";
