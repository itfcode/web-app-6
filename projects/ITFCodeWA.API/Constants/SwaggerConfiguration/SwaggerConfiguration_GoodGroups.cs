namespace ITFCodeWA.API.Constants
{
    public static partial class SwaggerConfiguration
    {
        ...
        {
            public const string TAG_DESCRIPTION = "Справочник <b>Группы товаров и услуг</b>";

            public const string GET_RESPONSE_DESCRIPTION = "Информация о группе товаров/услуг";
