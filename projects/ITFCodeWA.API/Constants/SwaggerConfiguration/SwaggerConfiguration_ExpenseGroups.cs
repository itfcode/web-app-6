namespace ITFCodeWA.API.Constants
{
    ...
    {
         public static class ExpenseGroups
        {
            public const string TAG_DESCRIPTION = "Справочник <b>Товары и услуги</b>";

            public const string GET_RESPONSE_DESCRIPTION = "Информация о товарах и услугах";
