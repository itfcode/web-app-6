namespace ITFCodeWA.API.Constants
{
    public static partial class SwaggerConfiguration
    {
        ...
        {
            public const string TAG_DESCRIPTION = "Справочник <b>Группы продуктов питания</b>";

            public const string GET_RESPONSE_DESCRIPTION = "Информация о группах продуктов питания";
