...
using static ITFCodeWA.API.Constants.SwaggerConfiguration.FoodGroups;

namespace ITFCodeWA.API.Controllers.References
{
    //[Route("api/[controller]")]
    [Route(ApiRoutes.FOOD_GROUPS)]
    [SwaggerTag(description: TAG_DESCRIPTION)]
    [ApiController]
    public class FoodGroupController : ReferenceApiController<IFoodGroupDataService, FoodGroupModel>
    {
        #region Constructors

        public FoodGroupController(ILogger<FoodGroupController> logger, ICurrentUserService currentUserService, IFoodGroupDataService dataService) :
        ...
        [SwaggerResponse(StatusCodes.Status200OK, POST_RESPONSE_DESCRIPTION, typeof(FoodGroupModel))]
        public override async Task<IActionResult> PostAsync([FromBody] FoodGroupModel model,
