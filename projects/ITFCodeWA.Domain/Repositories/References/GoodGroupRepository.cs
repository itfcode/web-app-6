...
{
    public class GoodGroupRepository : ReferenceRepository<LifeDataContext, GoodGroup>, IGoodGroupRepository
    {
        #region Constructors 

        public GoodGroupRepository([NotNull] LifeDataContext context) : base(context) { }
