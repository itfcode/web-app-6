namespace ITFCodeWA.Extensions.TypeExtendors.Tests.TestData
{
    internal static partial class TypeExtensionsTestData
    {
        ...
        {   //  canRead, canWrite, contains(STRING_VALUE), doesNotContain(STRING_VALUE)    
            new object[] { default(bool?), default(bool?), new string[] { "Static"}, new string[] { } },
            new object[] { true, default(bool?), new string[] { "Static", "Get" }, new string[] { } },
            new object[] { true, false, new string[] { "Static", "Get" }, new string[] { "Set" } },
            new object[] { default(bool?), true, new string[] { "Static", "Set" }, new string[] { } },
            new object[] { false, true, new string[] { "Static", "Set" }, new string[] { "Get" } },
        };

        public static IEnumerable<object[]> ForGetStaticPublicProperties = new List<object[]>
        {
            new object[] { default(bool?), default(bool?), new string[] { "Static", "Public" }, new string[] { "Internal", "Private", "Protected" } },
            new object[] { true, default(bool?), new string[] { "Static", "Public", "Get" }, new string[] { "Internal", "Private", "Protected" } },
            new object[] { true, false, new string[] { "Static", "Public", "Get" }, new string[] { "Set", "Internal", "Private", "Protected" } },
            new object[] { default(bool?), true, new string[] { "Static", "Public", "Set" }, new string[] { "Internal", "Private", "Protected"} },
            new object[] { false, true, new string[] { "Static", "Public", "Set" }, new string[] { "Get", "Internal", "Private", "Protected"} },
        };

        public static IEnumerable<object[]> ForGetStaticNonPublicProperties = new List<object[]>
        {
            new object[] { default(bool?), default(bool?), new string[] { "Static" }, new string[] { "Public" } },
            new object[] { true, default(bool?), new string[] { "Static", "Get" }, new string[] { "Public" } },
            new object[] { true, false, new string[] { "Static", "Get" }, new string[] { "Set", "Public" } },
            new object[] { default(bool?), true, new string[] { "Static", "Set" }, new string[] { "Public" } },
            new object[] { false, true, new string[] { "Static", "Set" }, new string[] { "Get", "Public" } },
        };

        public static IEnumerable<object[]> ForGetNonStaticProperties = new List<object[]>
        {   //  canRead, canWrite, contains(STRING_VALUE), doesNotContain(STRING_VALUE)    
            new object[] { default(bool?), default(bool?), new string[] { }, new string[] { "Static" } },
            new object[] { true, default(bool?), new string[] {  "Get" }, new string[] { "Static" } },
        ...
        {
            new object[] { default(bool?), default(bool?), new string[] { }, new string[] { "Public", "Static" } },
            new object[] { true, default(bool?), new string[] { "Get" }, new string[] { "Public", "Static" } },
            new object[] { true, false, new string[] { "Get" }, new string[] { "Set", "Public", "Static" } },
            new object[] { default(bool?), true, new string[] { "Set" }, new string[] { "Public", "Static" } },
            new object[] { false, true, new string[] { "Set" }, new string[] { "Get", "Public", "Static" } },
        };
